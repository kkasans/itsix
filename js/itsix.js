$(function () {
    ...
    // .menu와 .m_menu의 a 태그 속성 중 href의 #으로 시작하는 요소 클릭 시!!
    $(".menu li a[href^='#'], .m_menu li a[href^='#']").on("click", function () {
        ...
        // html,body 동시에 잡아주는 이유는 웹 호환성 때문
        // 일관된 동작 보장 위해 두개 다 잡아줌
    });

    // 햄버거버튼 클릭 시 - 모바일 메뉴 보기/가리기
